...
void loop() {
  ...
  else if (p < -40 && p >= -50) strcpy(state, "F4");
  // --- Dozadu (Backward) ---
  else if (p > 10 && p <= 20) strcpy(state, "B1");
  else if (p > 20 && p <= 30) strcpy(state, "B2");
  else if (p > 30 && p <= 40) strcpy(state, "B3");
  else if (p > 40 && p <= 50) strcpy(state, "B4");
  // --- Doleva (Left) ---
  else if (r < -10 && r >= -20) strcpy(state, "L1");
  else if (r < -20 && r >= -30) strcpy(state, "L2");
  else if (r < -30 && r >= -40) strcpy(state, "L3");
  else if (r < -40 && r >= -50) strcpy(state, "L4");
  // --- Doprava (Right) ---
  else if (r > 10 && r <= 20) strcpy(state, "R1");
  else if (r > 20 && r <= 30) strcpy(state, "R2");
  else if (r > 30 && r <= 40) strcpy(state, "R3");
  else if (r > 40 && r <= 50) strcpy(state, "R4");
