...
void readMacAddress(){
  ...
  if (ret == ESP_OK) {
    ...
    Serial.println("Nepodarilo se nacist MAC adresu");
  }
}
...
int speedLevels[4] = {100, 150, 200, 255};
...
void OnDataRecv(const esp_now_recv_info_t *info, const uint8_t *incomingData, int len) {
  ...
  char dir = myMessage.state[0];
  int level = myMessage.state[1] - '1';
